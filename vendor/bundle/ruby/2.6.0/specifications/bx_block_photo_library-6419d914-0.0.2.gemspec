# -*- encoding: utf-8 -*-
# stub: bx_block_photo_library-6419d914 0.0.2 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_photo_library-6419d914".freeze
  s.version = "0.0.2"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_photo_library".freeze
  s.rubygems_version = "3.0.3".freeze
  s.summary = "BxBlockPhotoLibrary".freeze
