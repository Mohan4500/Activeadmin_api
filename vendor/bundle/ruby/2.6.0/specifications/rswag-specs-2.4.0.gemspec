# -*- encoding: utf-8 -*-
# stub: rswag-specs 2.4.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activesupport>.freeze, [">= 3.1", "< 7.0"])
      s.add_runtime_dependency(%q<railties>.freeze, [">= 3.1", "< 7.0"])
      s.add_runtime_dependency(%q<json-schema>.freeze, ["~> 2.2"])
    else
      s.add_dependency(%q<activesupport>.freeze, [">= 3.1", "< 7.0"])
      s.add_dependency(%q<railties>.freeze, [">= 3.1", "< 7.0"])
