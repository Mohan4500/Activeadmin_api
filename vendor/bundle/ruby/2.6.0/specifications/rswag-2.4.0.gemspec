...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rswag-specs>.freeze, ["= 2.4.0"])
      s.add_runtime_dependency(%q<rswag-api>.freeze, ["= 2.4.0"])
      s.add_runtime_dependency(%q<rswag-ui>.freeze, ["= 2.4.0"])
    else
